    ...
    <div>
      {!reveal ? (
        <div
          id={`${traitName}`}
          onClick={revealTrait}
          className=" carousel-item relative mx-2 flex h-80 w-80 flex-col items-center justify-center rounded-3xl border-2 border-b-8 border-black bg-[#C7D6ED]"
        >
        ...
        >
          ...
          <p className="text-2xl font-bold text-white opacity-1">{tokenName}</p>
        </div>
      )}
    </div>
  );
