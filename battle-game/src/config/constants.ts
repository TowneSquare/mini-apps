...
export const DAPP_ADDRESS_TESTNET = process.env.NEXT_PUBLIC_DAPP_ADDRESS_TESTNET!; // changed here.
export const DAPP_ADDRESS_MAINNET = process.env.NEXT_PUBLIC_DAPP_ADDRESS_MAINNET!; 
...
export const COMPOSABLE_TOKEN_ENTRY_MODULE_ADDRESS_MAINNET = process.env.NEXT_PUBLIC_COMPOSABLE_TOKEN_ENTRY_MODULE_ADDRESS_MAINNET!
...
export const SLOTHBALL_COLLECTION_ADDRESS_TESTNET =
  ...
  export const SLOTHBALL_COLLECTION_ADDRESS_MAINNET =
  process.env.NEXT_PUBLIC_SLOTHBALL_COLLECTION_ADDRESS_MAINNET ||
  "0x53858a7a4b6faf7cb2d198efe80351abc658d9cefcd2e95587f3d473cc90a041";

export const NETWORK = process.env.NEXT_PUBLIC_APTOS_NETWORK!;

export const MODULE_URL = `https://explorer.aptoslabs.com/account/${DAPP_ADDRESS_MAINNET}/modules?network=${NETWORK}`;
...
export const GAME_START_TIME = 1727272800000
